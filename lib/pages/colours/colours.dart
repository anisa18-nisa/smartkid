...
import 'package:smartkid/pages/colours/colours_test.dart';
import 'package:smartkid/utils/assets_path.dart';

import 'package:smartkid/core/models/colours_model.dart';
...
class _ColoursPageState extends State<ColoursPage> {
  ...
  void _navigateToColoursTestPage(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const ColoursTestPage()),
    );
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              _navigateToColoursTestPage(context);
            },
          ),
        ],
      ),
